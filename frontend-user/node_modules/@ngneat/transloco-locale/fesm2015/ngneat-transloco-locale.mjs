...
function getDefaultOptions(locale, type, localeConfig) {
    ...
    const settings = localeConfig.localeBased
        ...
        : {};
    return (settings === null || settings === void 0 ? void 0 : settings[type])
        ? Object.assign(Object.assign({}, defaultConfig), settings[type]) : defaultConfig;
}
...
class DefaultNumberTransformer {
    transform(value, type, locale, options) {
        return localizeNumber(value, locale, Object.assign(Object.assign({}, options), { style: type }));
    }
}
...
class TranslocoLocaleService {
    ...
    localizeNumber(value, type, locale = this.getLocale(), options) {
        let resolved = options !== null && options !== void 0 ? options : getDefaultOptions(locale, type, this.localeConfig);
        if (type === 'currency') {
            resolved = Object.assign(Object.assign({}, resolved), { currency: resolved.currency || this._resolveCurrencyCode(locale) });
        }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoLocaleService, decorators: [{
        ...
        return [{ type: i1.TranslocoService }, { type: undefined, decorators: [{
                        type: Inject,
...
class TranslocoCurrencyPipe extends TranslocoLocalePipe {
    ...
    transform(value, display = 'symbol', numberFormatOptions = {}, currencyCode, locale) {
        ...
        const options = Object.assign(Object.assign(Object.assign({}, getDefaultOptions(locale, 'currency', this.localeConfig)), numberFormatOptions), { currencyDisplay: display, currency: currencyCode || this.translocoLocaleService._resolveCurrencyCode() });
...
TranslocoCurrencyPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoCurrencyPipe, deps: [{ token: TranslocoLocaleService }, { token: i0.ChangeDetectorRef }, { token: LOCALE_CONFIG }], target: i0.ɵɵFactoryTarget.Pipe });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoCurrencyPipe, decorators: [{
        ...
        return [{ type: TranslocoLocaleService }, { type: i0.ChangeDetectorRef }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [LOCALE_CONFIG]
                    }] }];
    } });
...
class TranslocoDatePipe extends TranslocoLocalePipe {
    ...
    transform(date, options = {}, locale) {
        if (isNil(date))
            return '';
        locale = this.getLocale(locale);
        return this.translocoLocaleService.localizeDate(date, locale, Object.assign(Object.assign({}, getDefaultOptions(locale, 'date', this.localeConfig)), options));
    }
    ngOnDestroy() {
        super.onDestroy();
    }
}
TranslocoDatePipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoDatePipe, deps: [{ token: TranslocoLocaleService }, { token: i0.ChangeDetectorRef }, { token: LOCALE_CONFIG }], target: i0.ɵɵFactoryTarget.Pipe });
...
class TranslocoDecimalPipe extends TranslocoLocalePipe {
    ...
    transform(value, numberFormatOptions = {}, locale) {
        if (isNil(value))
            return '';
        locale = this.getLocale(locale);
        const options = Object.assign(Object.assign({}, getDefaultOptions(locale, 'decimal', this.localeConfig)), numberFormatOptions);
...
TranslocoDecimalPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoDecimalPipe, deps: [{ token: TranslocoLocaleService }, { token: i0.ChangeDetectorRef }, { token: LOCALE_CONFIG }], target: i0.ɵɵFactoryTarget.Pipe });
...
class TranslocoPercentPipe extends TranslocoLocalePipe {
    ...
    transform(value, numberFormatOptions = {}, locale) {
        if (isNil(value))
            return '';
        locale = this.getLocale(locale);
        const options = Object.assign(Object.assign({}, getDefaultOptions(locale, 'percent', this.localeConfig)), numberFormatOptions);
...
TranslocoPercentPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoPercentPipe, deps: [{ token: TranslocoLocaleService }, { token: i0.ChangeDetectorRef }, { token: LOCALE_CONFIG }], target: i0.ɵɵFactoryTarget.Pipe });
TranslocoPercentPipe.ɵpipe = i0.ɵɵngDeclarePipe({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoPercentPipe, name: "translocoPercent", pure: false });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoPercentPipe, decorators: [{
            type: Pipe,
            args: [{
        ...
        return {
            ...
            providers: [
                ...
                },
                {
                    ...
                    useValue: config.localeToCurrencyMapping ||
...
TranslocoLocaleModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoLocaleModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TranslocoLocaleModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoLocaleModule, declarations: [TranslocoCurrencyPipe,
        TranslocoDatePipe,
        TranslocoDecimalPipe,
        ...
        TranslocoDecimalPipe,
        TranslocoPercentPipe] });
TranslocoLocaleModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoLocaleModule });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.0", ngImport: i0, type: TranslocoLocaleModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: pipes,
                    exports: pipes,
