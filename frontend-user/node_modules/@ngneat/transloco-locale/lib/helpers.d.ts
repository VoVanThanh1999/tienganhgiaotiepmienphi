 ...
 */
export declare function isLocaleFormat(val: any): val is Locale;
export declare function localizeNumber(value: number | string, locale: Locale, options: NumberFormatOptions): string;
