...
export declare type LocaleConfigMapping = Record<string, LocaleFormatOptions>;
export declare type LangToLocaleMapping = Record<string, Locale>;
export declare type LocaleToCurrencyMapping = Record<string, Currency>;
