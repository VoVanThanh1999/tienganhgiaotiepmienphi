(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-hover-preload', ['@angular/core','@angular/router','exports', '@angular/core', '@angular/router', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.router,global['ngx-hover-preload'] = {}, global.ng.core, global.ng.router, global.rxjs));
}(this, (function (ɵngcc0,ɵngcc1,exports, i0, i1, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var RegistryService = /** @class */ (function () {
        function RegistryService(router) {
            this.router = router;
        ...
        RegistryService.prototype.add = function (route) {
            this._queue.add(route);
        };
        RegistryService.prototype.shouldPrefetch = function (url) {
            var tree = this.router.parseUrl(url);
            return __spread(this._queue).some(containsTree.bind(null, tree));
        };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RegistryService, [{
    ...
    RegistryService.ctorParameters = function () { return [
        { type: i1.Router }
    ]; };
    ...
    function containsSegmentGroup(container, containee, containeePaths) {
        if (container.segments.length > containeePaths.length) {
            ...
            if (!container.children[i1.PRIMARY_OUTLET])
                return false;
            return containsSegmentGroup(container.children[i1.PRIMARY_OUTLET], containee, next);
        }
    }
    ...
    var LinkDirective = /** @class */ (function () {
        function LinkDirective(_loader, _registry, link, linkWithHref) {
            this._loader = _loader;
            this._registry = _registry;
            this._rl = link || linkWithHref;
        }
        LinkDirective.prototype.prefetch = function () {
            var _this = this;
            requestIdleCallback(function () {
                _this._registry.add(_this._rl.urlTree);
                _this._loader.preload().subscribe(function () { return void 0; });
            });
        };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(LinkDirective, [{
    ...
    LinkDirective.ctorParameters = function () { return [
        ...
        { type: i1.RouterLink, decorators: [{ type: i0.Optional }] },
        { type: i1.RouterLinkWithHref, decorators: [{ type: i0.Optional }] }
    ]; };
    var ɵ0 = function (cb) {
        var start = Date.now();
    ...
    var HoverPreloadStrategy = /** @class */ (function () {
        function HoverPreloadStrategy(_router, _registry) {
            this._router = _router;
            this._registry = _registry;
            this._loading = new Set();
        }
        HoverPreloadStrategy.prototype.preload = function (route, load) {
            ...
            var path = findPath(this._router.config, route);
...
HoverPreloadStrategy.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: HoverPreloadStrategy, factory: function (t) { return HoverPreloadStrategy.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(HoverPreloadStrategy, [{
    ...
    HoverPreloadStrategy.ctorParameters = function () { return [
        { type: i1.Router },
        { type: RegistryService }
    ]; };
    ...
    function isPrimaryRoute(route) {
        return route.outlet === i1.PRIMARY_OUTLET || !route.outlet;
    }

    var HoverPreloadModule = /** @class */ (function () {
        function HoverPreloadModule() {
        }
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(HoverPreloadModule, { declarations: [LinkDirective], exports: [LinkDirective] }); })();
    ...
    exports.HoverPreloadModule = HoverPreloadModule;
    exports.HoverPreloadStrategy = HoverPreloadStrategy;
    exports.ɵa = RegistryService;
...
//# sourceMappingURL=ngx-hover-preload.umd.js.map